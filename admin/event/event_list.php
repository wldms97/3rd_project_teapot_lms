...
// //상태업데이트
// $update1 = "UPDATE lms_event set status=-1 where status=1 and duedate < NOW() - INTERVAL 1 DAY";
// $result = $mysqli->query($update1);
// $update2 = "UPDATE lms_event set status=1 where status=-1 and duedate > NOW() - INTERVAL 1 DAY";
...
?>
        <main class="p-5 col-md-10">
          ...
          <table class="table">
            ...
            <?php
              foreach($rsc as $r){
                $sqlc = "SELECT * from lms_coupon_cat where cc_name='{$r->cc_name}'";
            ...
            ?>
              <tr>
                <td><img src="/green/3rd/admin/uploads/event/<?php echo $r->ev_thumb;?>"></td>
                ...
                <td class="event_btn">
                  <div>
                    ...
                    <button class="btn_s go" onclick="window.open('/green/3rd/user/event/event_detail.php?idx=<?php echo $r->ev_idx?>')">바로가기</button>
                  </div>
                </td>
              </tr>
              <?php
